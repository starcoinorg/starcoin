...
use crate::protocol::{CustomMessageOutcome, generic_proto::NotificationsSink};
...
pub trait BusinessLayerHandle {
    ...
    fn build_handshake_msg(&mut self, notif_protocols: Vec<Cow<'static, str>>, rpc_protocols: Vec<Cow<'static, str>>) -> Result<Vec<u8>, Error>;
