...
impl TemplateTxProvider for TxPoolService {
    fn get_txns_with_state(&self, max: u64, state_root: HashValue) -> Vec<MultiSignedUserTransaction> {
    ...
    P: TemplateTxProvider + TxPoolSyncService + 'static,
{
    ...
    fn fetch_transactions(
        ...
        let mut pending_multi_transactions = self.tx_provider.get_txns_with_state(max_txns, state_root);
