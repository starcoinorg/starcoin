...
// use network::sync_messages::{BatchBodyMsg, BatchHeaderMsg, HashWithNumber};
// use std::sync::Arc;
...
//         Processor::handle_get_hash_by_number_msg(first.processor.clone(), get_hash_by_number_msg.1)
//             .await;
//
