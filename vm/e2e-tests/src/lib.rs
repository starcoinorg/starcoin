...
//! Test infrastructure for the Starcoin VM.
//!
//! This crate contains helpers for executing tests against the Starcoin VM.

use starcoin_vm_types::{transaction::TransactionStatus, vm_status::KeptVMStatus};
