...
/// converted to micro starcoin, falls below this threshold, transactions are expected to fail with
...
fn compute_gas_used(txn: SignedUserTransaction, executor: &mut FakeExecutor) -> u64 {
