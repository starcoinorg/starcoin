...
<dt>
<code>block_gas_limit: u128</code>
</dt>
<dd>
...
<pre><code><b>public</b> <b>fun</b> <a href="ConsensusConfig.md#0x1_ConsensusConfig_initialize">initialize</a>(
    ...
    move_to&lt;<a href="ConsensusConfig.md#0x1_ConsensusConfig_Epoch">Epoch</a>&gt;(
        ...
        <a href="ConsensusConfig.md#0x1_ConsensusConfig_Epoch">Epoch</a> {
            ...
            block_gas_limit: (base_block_gas_limit <b>as</b> u128),
...
<b>acquires</b> <a href="ConsensusConfig.md#0x1_ConsensusConfig_Epoch">Epoch</a>, <a href="ConsensusConfig.md#0x1_ConsensusConfig_EpochData">EpochData</a> {
    ...
    <b>let</b> (new_epoch, reward_per_block) = <b>if</b> (block_number &lt; epoch_ref.end_number) {
        ...
        <a href="ConsensusConfig.md#0x1_ConsensusConfig_adjust_gas_limit">adjust_gas_limit</a>(epoch_ref, last_epoch_time_target, new_epoch_block_time_target, last_epoch_total_gas);
...
<pre><code><b>fun</b> <a href="ConsensusConfig.md#0x1_ConsensusConfig_adjust_gas_limit">adjust_gas_limit</a>(epoch_ref: &<b>mut</b> <a href="ConsensusConfig.md#0x1_ConsensusConfig_Epoch">ConsensusConfig::Epoch</a>, last_epoch_time_target: u64, new_epoch_time_target: u64, last_epoch_total_gas: u128)
</code></pre>
...
<pre><code><b>fun</b> <a href="ConsensusConfig.md#0x1_ConsensusConfig_adjust_gas_limit">adjust_gas_limit</a>(epoch_ref: &<b>mut</b> <a href="ConsensusConfig.md#0x1_ConsensusConfig_Epoch">Epoch</a>, last_epoch_time_target: u64, new_epoch_time_target: u64, last_epoch_total_gas:u128) {
    <b>let</b> new_gas_limit = <a href="ConsensusConfig.md#0x1_ConsensusConfig_compute_gas_limit">compute_gas_limit</a>(last_epoch_time_target, new_epoch_time_target, epoch_ref.block_gas_limit, last_epoch_total_gas);
...
<pre><code><b>fun</b> <a href="ConsensusConfig.md#0x1_ConsensusConfig_compute_gas_limit">compute_gas_limit</a>(last_epoch_time_target: u64, new_epoch_time_target: u64, last_epoch_block_gas_limit: u128, last_epoch_total_gas: u128): <a href="Option.md#0x1_Option_Option">Option::Option</a>&lt;u128&gt;
</code></pre>
...
<pre><code><b>fun</b> <a href="ConsensusConfig.md#0x1_ConsensusConfig_compute_gas_limit">compute_gas_limit</a>(last_epoch_time_target: u64, new_epoch_time_target: u64, last_epoch_block_gas_limit: u128, last_epoch_total_gas: u128) : <a href="Option.md#0x1_Option_Option">Option::Option</a>&lt;u128&gt; {
    <b>let</b> config = <a href="ConsensusConfig.md#0x1_ConsensusConfig_get_config">get_config</a>();
    <b>let</b> maybe_adjust_gas_limit = (last_epoch_total_gas &gt;= <a href="Math.md#0x1_Math_mul_div">Math::mul_div</a>(last_epoch_block_gas_limit * (config.epoch_block_count <b>as</b> u128) , (80 <b>as</b> u128), (<a href="ConsensusConfig.md#0x1_ConsensusConfig_HUNDRED">HUNDRED</a> <b>as</b> u128)));
    <b>let</b> new_gas_limit = <a href="Option.md#0x1_Option_none">Option::none</a>&lt;u128&gt;();
...
<pre><code><b>fun</b> <a href="ConsensusConfig.md#0x1_ConsensusConfig_in_or_decrease_gas_limit">in_or_decrease_gas_limit</a>(last_epoch_block_gas_limit: u128, percent: u64, min_block_gas_limit: u64): u128
</code></pre>
...
<pre><code><b>fun</b> <a href="ConsensusConfig.md#0x1_ConsensusConfig_in_or_decrease_gas_limit">in_or_decrease_gas_limit</a>(last_epoch_block_gas_limit: u128, percent: u64, min_block_gas_limit: u64): u128 {
    <b>let</b> tmp_gas_limit = <a href="Math.md#0x1_Math_mul_div">Math::mul_div</a>(last_epoch_block_gas_limit, (percent <b>as</b> u128), (<a href="ConsensusConfig.md#0x1_ConsensusConfig_HUNDRED">HUNDRED</a> <b>as</b> u128));
    <b>let</b> new_gas_limit = <b>if</b> (tmp_gas_limit &gt; (min_block_gas_limit  <b>as</b> u128)) {
        tmp_gas_limit
    } <b>else</b> {
        (min_block_gas_limit <b>as</b> u128)
    };
