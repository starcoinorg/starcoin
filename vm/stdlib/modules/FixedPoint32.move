...
module FixedPoint32 {
    ...
    FixedPoint32 is used in the invariants of other modules.
    ...
    * Let FP32 refer to FixedPoint32 which is the 64-bit unsigned fixed-point numeric type with 32 factional bits.
