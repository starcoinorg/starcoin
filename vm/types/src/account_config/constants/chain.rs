...
pub static G_BLOCK_MODULE_NAME: &str = "Block";
pub static G_TRANSACTION_MANAGER_MODULE_NAME: &str = "TransactionManager";
...
pub static G_TRANSACTION_MANAGER_MODULE: Lazy<ModuleId> = Lazy::new(|| {
    ModuleId::new(
        CORE_CODE_ADDRESS,
