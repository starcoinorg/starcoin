...
crate::natives::define_gas_parameters_for_natives!(GasParameters, "starcoin_natives", [
    [.signature.ed25519_verify.base,  "signature.ed25519_verify.base", (61 + 1) * MUL],
    [.signature.ed25519_verify.per_byte, optional "signature.ed25519_verify.per_byte", 2* MUL],
    [.signature.ed25519_validate_key.base,  "signature.ed25519_validate_key.base", (26 + 1) * MUL],
    ...
    [.hash.keccak256.base, optional "hash.keccak256.base", (64 + 1) * MUL],
    [.hash.keccak256.per_byte, optional "hash.keccak256.per_byte",  MUL],
    [.hash.ripemd160.base,  optional "hash.ripemd160.base", (64 + 1) * MUL],
    [.hash.ripemd160.per_byte, optional "hash.ripemd160.per_byte", MUL],
    [.signature.ec_recover.base,  optional "signature.ec_recover.base", (128 + 1) * MUL],
    [.signature.ec_recover.per_byte,  optional "signature.ec_recover.per_byte",  MUL],

    [.u256.from_bytes.base,  optional "u256.from_bytes.base",  (2 + 1) * MUL],
