...
module creator::XMembership {
    use starcoin_framework::NFT::{Self, MintCapability, BurnCapability, UpdateCapability};
    use starcoin_framework::IdentifierNFT;
    use starcoin_framework::Token::{Self, Token};
    ...
    public fun join(sender: &signer, fee: u128) acquires XMembershipMintCapability, XMembershipInfo{
        let token = coin::withdraw<STC>(sender, fee);
