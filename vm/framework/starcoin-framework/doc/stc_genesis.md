...
<pre><code><b>public</b> entry <b>fun</b> <a href="stc_genesis.md#0x1_stc_genesis_initialize">initialize</a>(
    ...
    <b>let</b> txfee_receiver = <a href="stc_transaction_fee.md#0x1_stc_transaction_fee_transaction_fee_receiver_account_from">stc_transaction_fee::transaction_fee_receiver_account_from</a>();
    <b>while</b> (txfee_receiver &lt;= <a href="stc_transaction_fee.md#0x1_stc_transaction_fee_transaction_fee_receiver_account_to">stc_transaction_fee::transaction_fee_receiver_account_to</a>()) {
        <b>let</b> addr = <a href="../../starcoin-stdlib/doc/from_bcs.md#0x1_from_bcs_u128_to_address">from_bcs::u128_to_address</a>(txfee_receiver);
...
<pre><code><b>fun</b> <a href="stc_genesis.md#0x1_stc_genesis_create_genesis_accounts">create_genesis_accounts</a>() {
    ...
    //     <a href="../../starcoin-stdlib/doc/debug.md#0x1_debug_print">debug::print</a>(&addr_value);
        // <b>let</b> addr = <a href="../../starcoin-stdlib/doc/from_bcs.md#0x1_from_bcs_to_address">from_bcs::to_address</a>(x"0000000000000000000000000000000a");
        ...
        // <b>let</b> account_signer = <a href="create_signer.md#0x1_create_signer_create_signer">create_signer::create_signer</a>(addr);
