...
<pre><code><b>public</b> entry <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_batch_transfer">batch_transfer</a>(source: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, recipients: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;, amounts: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u64&gt;) {
    <b>let</b> recipients_len = <a href="../../move-stdlib/doc/vector.md#0x1_vector_length">vector::length</a>(&recipients);
    <b>assert</b>!(
        recipients_len == <a href="../../move-stdlib/doc/vector.md#0x1_vector_length">vector::length</a>(&amounts),
        <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="starcoin_account.md#0x1_starcoin_account_EMISMATCHING_RECIPIENTS_AND_AMOUNTS_LENGTH">EMISMATCHING_RECIPIENTS_AND_AMOUNTS_LENGTH</a>),
    );

    <a href="../../move-stdlib/doc/vector.md#0x1_vector_enumerate_ref">vector::enumerate_ref</a>(&recipients, |i, <b>to</b>| {
...
<pre><code><b>public</b> entry <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_batch_transfer_coins">batch_transfer_coins</a>&lt;CoinType&gt;(from: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, recipients: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;, amounts: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u64&gt;)
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_batch_transfer_coins">batch_transfer_coins</a>&lt;CoinType&gt;(
    from: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, recipients: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;, amounts: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u64&gt;) <b>acquires</b> <a href="starcoin_account.md#0x1_starcoin_account_DirectTransferConfig">DirectTransferConfig</a> {
    <b>let</b> recipients_len = <a href="../../move-stdlib/doc/vector.md#0x1_vector_length">vector::length</a>(&recipients);
    <b>assert</b>!(
        recipients_len == <a href="../../move-stdlib/doc/vector.md#0x1_vector_length">vector::length</a>(&amounts),
        <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="starcoin_account.md#0x1_starcoin_account_EMISMATCHING_RECIPIENTS_AND_AMOUNTS_LENGTH">EMISMATCHING_RECIPIENTS_AND_AMOUNTS_LENGTH</a>),
...
<pre><code><b>public</b> entry <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_transfer_coins">transfer_coins</a>&lt;CoinType&gt;(from: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, <b>to</b>: <b>address</b>, amount: u64)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_deposit_coins">deposit_coins</a>&lt;CoinType&gt;(<b>to</b>: <b>address</b>, coins: Coin&lt;CoinType&gt;) <b>acquires</b> <a href="starcoin_account.md#0x1_starcoin_account_DirectTransferConfig">DirectTransferConfig</a> {
    ...
    <b>if</b> (!<a href="coin.md#0x1_coin_is_account_registered">coin::is_account_registered</a>&lt;CoinType&gt;(<b>to</b>)) {
        <b>assert</b>!(
            ...
            <a href="../../move-stdlib/doc/error.md#0x1_error_permission_denied">error::permission_denied</a>(<a href="starcoin_account.md#0x1_starcoin_account_EACCOUNT_DOES_NOT_ACCEPT_DIRECT_COIN_TRANSFERS">EACCOUNT_DOES_NOT_ACCEPT_DIRECT_COIN_TRANSFERS</a>),
        );
...
<pre><code><b>public</b> <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_assert_account_exists">assert_account_exists</a>(addr: <b>address</b>) {
    <b>assert</b>!(<a href="account.md#0x1_account_exists_at">account::exists_at</a>(addr), <a href="../../move-stdlib/doc/error.md#0x1_error_not_found">error::not_found</a>(<a href="starcoin_account.md#0x1_starcoin_account_EACCOUNT_NOT_FOUND">EACCOUNT_NOT_FOUND</a>));
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_set_allow_direct_coin_transfers">set_allow_direct_coin_transfers</a>(<a href="account.md#0x1_account">account</a>: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, allow: bool)
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_set_allow_direct_coin_transfers">set_allow_direct_coin_transfers</a>(<a href="account.md#0x1_account">account</a>: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, allow: bool) <b>acquires</b> <a href="starcoin_account.md#0x1_starcoin_account_DirectTransferConfig">DirectTransferConfig</a> {
...
<pre><code><b>public</b>(<b>friend</b>) entry <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_fungible_transfer_only">fungible_transfer_only</a>(
    ...
    <b>let</b> sender_store = <a href="starcoin_account.md#0x1_starcoin_account_ensure_primary_fungible_store_exists">ensure_primary_fungible_store_exists</a>(<a href="../../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(source));
