...
module starcoin_framework::reconfiguration {
    use std::error;
    use std::features;
    use std::signer;
    ...
    public(friend) fun initialize(starcoin_framework: &signer) {
        ...
        move_to<Configuration>(
            ...
            Configuration {
                ...
                events: account::new_event_handle<NewEpochEvent>(starcoin_framework),
            }
        );
    }
    ...
    fun reconfiguration_enabled(): bool {
        !exists<DisableReconfiguration>(@starcoin_framework)
    }
    ...
    public(friend) fun reconfigure() acquires Configuration {
        ...
        let config_ref = borrow_global_mut<Configuration>(@starcoin_framework);
    ...
    public fun last_reconfiguration_time(): u64 acquires Configuration {
        borrow_global<Configuration>(@starcoin_framework).last_reconfiguration_time
    }

    public fun current_epoch(): u64 acquires Configuration {
        borrow_global<Configuration>(@starcoin_framework).epoch
    }
