...
///
module starcoin_token_objects::object_token {
    use std::error;
    use std::features;
    ...
    #[test(creator = @0x123, trader = @0x456)]
    #[expected_failure(abort_code = 0x40002, location = starcoin_token_objects::object_token)]
    ...
    #[test(creator = @0x123, trader = @0x456, starcoin_framework = @starcoin_framework)]
    #[expected_failure(abort_code = 0x40008, location = starcoin_token_objects::object_token)]
