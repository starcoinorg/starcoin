...
module starcoin_token_objects::collection {
    use std::error;
    use std::features;
    ...
    #[test(creator = @0x123)]
    #[expected_failure(abort_code = 0x1000A, location = starcoin_token_objects::collection)]
    ...
    #[test(creator = @0x123)]
    #[expected_failure(abort_code = 0x20009, location = starcoin_token_objects::collection)]
