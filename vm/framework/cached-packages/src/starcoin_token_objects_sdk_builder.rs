    ...
    pub fn encode(self) -> TransactionPayload {
        ...
        match self {
            StarcoinTokenCreateCollection {
                ...
                royalty_numerator,
                royalty_denominator,
            } => starcoin_token_create_collection(
                description,
                max_supply,
                name,
                uri,
            ...
            StarcoinTokenMintSoulBound {
                ...
                property_values,
                soul_bound_to,
            } => starcoin_token_mint_soul_bound(
                collection,
                description,
                name,
                uri,
...
static SCRIPT_FUNCTION_DECODER_MAP: once_cell::sync::Lazy<EntryFunctionDecoderMap> =
    once_cell::sync::Lazy::new(|| {
        ...
        map.insert(
            "starcoin_token_create_collection".to_string(),
            Box::new(decoder::starcoin_token_create_collection),
        );
        map.insert(
            "starcoin_token_mint".to_string(),
            Box::new(decoder::starcoin_token_mint),
        );
        map.insert(
            "starcoin_token_mint_soul_bound".to_string(),
            Box::new(decoder::starcoin_token_mint_soul_bound),
        );
        map
    });
