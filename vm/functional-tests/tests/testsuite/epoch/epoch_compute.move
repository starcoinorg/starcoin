script {
    ...
    fun compute_next_block_time_target() {
        ...
        let min_block_time_target = 5000;
        ...
        let total_uncles = 0;
        let now_milli_seconds = epoch_block_count*base_block_time_target;
        assert(Epoch::compute_next_block_time_target(&config,last_block_time_target, 0, now_milli_seconds,  0, epoch_block_count, total_uncles) < base_block_time_target, 103);
