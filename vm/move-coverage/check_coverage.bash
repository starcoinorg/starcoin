...
echo "---------------------------------------------------------------------------"
cargo run --bin coverage-summaries -- -t trace.mvcov -s ../../networks/stdlib/latest/stdlib
...
echo "> cargo run --bin coverage-summaries -- -t trace.mvcov -s ../../networks/stdlib/latest/stdlib"
echo "==========================================================================="
