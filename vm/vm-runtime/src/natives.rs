...
pub fn starcoin_natives( gas_params: NativeGasParameters) -> NativeFunctionTable {
    ...
    add_natives_from_module!("starcoin_hash", starcoin_natives::hash::make_all(gas_params.starcoin_natives.hash));
    add_natives_from_module!("bcs", move_stdlib::natives::bcs::make_all(gas_params.move_stdlib.bcs));
    add_natives_from_module!("signature", starcoin_natives::signature::make_all(gas_params.starcoin_natives.signature));
    add_natives_from_module!("vector", move_stdlib::natives::vector::make_all(gas_params.move_stdlib.vector));
