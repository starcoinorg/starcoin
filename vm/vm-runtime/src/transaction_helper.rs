...
use libra_types::{
    transaction::{
        ...
        RawTransaction as LibraRawTransaction,
        ...
        TransactionOutput as LibraTransactionOutput,
    },
...
impl TransactionHelper {
    ...
    pub fn to_libra_TransactionArgument(arg: &TransactionArgument) -> LibraTransactionArgument{
        match arg {
            ...
            TransactionArgument::Address(address) => LibraTransactionArgument::Address(Self::to_libra_AccountAddress(*address)),
            TransactionArgument::ByteArray(byte_array) => LibraTransactionArgument::ByteArray(LibraByteArray::new((byte_array.clone()).into_inner()))
        }
    }
    pub fn to_libra_Script(s: Script) -> LibraScript{
        let args = s.args().iter().map(|arg| Self::to_libra_TransactionArgument(arg)).collect();
    ...
    pub fn to_libra_TransactionPayload(payload: TransactionPayload) -> LibraTransactionPayload{
        match payload {
            TransactionPayload::Script(s) => LibraTransactionPayload::Script(Self::to_libra_Script(s)),
            TransactionPayload::Module(m) => LibraTransactionPayload::Module(Self::to_libra_Module(m))
        }
    }
