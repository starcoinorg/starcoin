...
/// Returns a transaction to create a new account with the given arguments.
pub fn create_account_txn_send_with_genesis_account(
    new_account: &Account,
    seq_num: u64,
    initial_amount: u64,
) -> SignedUserTransaction {
    ...
    create_signed_txn_with_genesis_account(
...
/// Returns a transaction to transfer coin from one account to another (possibly new) one, with the
/// given arguments.
pub fn peer_to_peer_txn_send_by_genesis_account(
    receiver: &Account,
    seq_num: u64,
    transfer_amount: u64,
) -> SignedUserTransaction {
...
/// Returns a transaction to mint new funds with the given arguments.
pub fn mint_txn_send_by_genesis_account(
    receiver: &Account,
    seq_num: u64,
    transfer_amount: u64,
) -> SignedUserTransaction {
