...
pub struct PeerInfo {
    pub peer_id: PeerId,
    pub chain_state_info: ChainStateInfo,
...
impl PeerInfo {
    ...
    pub fn chain_info(&self) -> &ChainStateInfo {
    ...
    pub fn latest_header(&self) -> &BlockHeader {
        self.chain_state_info.chain_info.head()
    }

    pub fn block_id(&self) -> HashValue {
        self.chain_state_info.chain_info.head().id()
    }

    pub fn total_difficulty(&self) -> U256 {
        self.chain_state_info.chain_info.total_difficulty()
    }

    pub fn update_chain_status(&mut self, chain_status: ChainStatus) {
        self.chain_state_info.chain_info.update_status(chain_status)
    }
    ...
    pub fn random() -> Self {
        Self {
            ...
            chain_state_info: ChainStateInfo::random(),
            notif_protocols: vec![],
            rpc_protocols: vec![],
            version_string: None,
        }
