...
impl BlockChain {
    fn execute_dag_block(&mut self, verified_block: VerifiedBlock) -> Result<ExecutedBlock> {
        ...
        info!("jacktest: execute dag block1:{:?}", block_id);
        ...
        info!("jacktest: execute dag block2:{:?}", block_id);
        ...
        info!("jacktest: execute dag block3:{:?}", block_id);
        ...
        info!("jacktest: execute dag block4:{:?}", block_id);
        // Update state roots
