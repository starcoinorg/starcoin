...
impl ChainReaderServiceInner {
    ...
    pub fn get_event_by_txn_hash2(
        ...
        let events = self
            .get_events_by_txn_info_hash2(txn_info.txn_info2().id())?
            .unwrap_or_default();
    ...
    pub fn get_transaction_info2(
        &self,
        txn_hash: HashValue,
    ) -> anyhow::Result<Option<MultiRichTransactionInfo>, Error> {
        self.main.get_transaction_info2(txn_hash)
    }
}
