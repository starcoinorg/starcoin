...
fn test_next_target_zero_one() {
    // Test empty blocks - should error
    assert!(
    ...
    let next_target = get_next_target_helper(
        ...
        0, // time_used doesn't matter for single block
        10_000,
    )
    .unwrap();
...
#[stest::test]
fn test_next_target_dag_blocks() {
...
// Deleted - duplicate of test_next_target_increase_difficulty and test_next_target_decrease_difficulty
...
fn test_next_target_increment_difficulty_compare() {
    ...
    let time_used_2 = time_plan * 2; // Same total time but different distribution
    ...
    assert_eq!(next_target_1, next_target_2);
}

#[stest::test]
fn test_next_target_increase_difficulty() {
...
#[stest::test]
fn test_next_target_decrease_difficulty() {
    ...
    // No change needed
    assert_eq!(next_target, 10000.into());
}

#[stest::test]
fn test_next_target_time_used_zero() {
...
#[stest::test]
fn test_next_target_dag_many_blocks() {
