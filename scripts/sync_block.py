...
def check_or_do(network):
    ...
    if export_height - int(last_export_height) > 10000:
        ...
        # debug why it return code 1, while it shoud be 0.
        os.system("kubectl exec -it -n starcoin-%s starcoin-1 -- bash -c \"more /sc-data/snapshot/acc_node_block | wc -l \"" % network)
