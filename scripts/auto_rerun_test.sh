...
RUST_LOG=OFF RUST_BACKTRACE=0 cargo xtest --no-fail-fast --exclude starcoin-move-prover -j 15 -Z unstable-options --report-time -- --test-threads=10 --color never --format pretty |tee "$TEST_RESULT_FILE" ||true
