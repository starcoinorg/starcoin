...
pub struct ImportMultisigOpt {
    ...
    #[clap(long = "pubkey", num_args=0..=32, value_parser=Ed25519PublicKey::from_encoded_string)]
    ...
    #[clap(long = "prikey", num_args=0..=32, value_parser=Ed25519PrivateKey::from_encoded_string)]
    /// hex encoded private key, if you control multi private keys, provide multi args.
    private_keys: Vec<Ed25519PrivateKey>,

    #[clap(long = "prikey-file", num_args=0..=32)]
