...
crate::gas_schedule::macros::define_gas_parameters!(
    ...
    [
        [hash_sha2_256_base:InternalGas, "hash.sha2_256.base", 0],
        ...
        [hash_sha3_256_base:InternalGas, "hash.sha3_256.base", 0],
        ...
        [string_sub_string_base:InternalGas,  "string.sub_string.base", 0],
        [string_sub_string_per_byte:InternalGasPerByte,  "string.sub_string.per_byte", (4 + 1) *  MUL],
        [string_index_of_base:InternalGas,  "string.index_of.base", 0],
        ...
        [vector_spawn_from_base:InternalGas,  "vector.spawn_from.base", 0],
    ]
);
