...
-  [Resource `StarcoinCoinCapabilities`](#0x1_transaction_fee_StarcoinCoinCapabilities)
-  [Resource `StarcoinFABurnCapabilities`](#0x1_transaction_fee_StarcoinFABurnCapabilities)
-  [Resource `StarcoinCoinMintCapability`](#0x1_transaction_fee_StarcoinCoinMintCapability)
...
-  [Function `store_starcoin_coin_burn_cap`](#0x1_transaction_fee_store_starcoin_coin_burn_cap)
-  [Function `convert_to_starcoin_fa_burn_ref`](#0x1_transaction_fee_convert_to_starcoin_fa_burn_ref)
-  [Function `store_starcoin_coin_mint_cap`](#0x1_transaction_fee_store_starcoin_coin_mint_cap)
...
-  [Specification](#@Specification_1)
    ...
    -  [Function `store_starcoin_coin_burn_cap`](#@Specification_1_store_starcoin_coin_burn_cap)
    -  [Function `store_starcoin_coin_mint_cap`](#@Specification_1_store_starcoin_coin_mint_cap)
...
<a id="0x1_transaction_fee_StarcoinCoinCapabilities"></a>
...
<pre><code><b>struct</b> <a href="transaction_fee.md#0x1_transaction_fee_StarcoinCoinCapabilities">StarcoinCoinCapabilities</a> <b>has</b> key
</code></pre>
...
<a id="0x1_transaction_fee_StarcoinFABurnCapabilities"></a>

## Resource `StarcoinFABurnCapabilities`

Stores burn capability to burn the gas fees.


<pre><code><b>struct</b> <a href="transaction_fee.md#0x1_transaction_fee_StarcoinFABurnCapabilities">StarcoinFABurnCapabilities</a> <b>has</b> key
</code></pre>
...
<a id="0x1_transaction_fee_StarcoinCoinMintCapability"></a>

## Resource `StarcoinCoinMintCapability`

Stores mint capability to mint the refunds.


<pre><code><b>struct</b> <a href="transaction_fee.md#0x1_transaction_fee_StarcoinCoinMintCapability">StarcoinCoinMintCapability</a> <b>has</b> key
</code></pre>
...
<dt>
<code>proposer: <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/option.md#0x1_option_Option">option::Option</a>&lt;<b>address</b>&gt;</code>
</dt>
<dd>
...
<pre><code><b>public</b> <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_initialize_fee_collection_and_distribution">initialize_fee_collection_and_distribution</a>(starcoin_framework: &<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer">signer</a>, burn_percentage: u8)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_initialize_fee_collection_and_distribution">initialize_fee_collection_and_distribution</a>(starcoin_framework: &<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer">signer</a>, burn_percentage: u8) {
    ...
    <b>assert</b>!(
        !<b>exists</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_CollectedFeesPerBlock">CollectedFeesPerBlock</a>&gt;(@starcoin_framework),
        <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/error.md#0x1_error_already_exists">error::already_exists</a>(<a href="transaction_fee.md#0x1_transaction_fee_EALREADY_COLLECTING_FEES">EALREADY_COLLECTING_FEES</a>)
    );
    <b>assert</b>!(burn_percentage &lt;= 100, <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/error.md#0x1_error_out_of_range">error::out_of_range</a>(<a href="transaction_fee.md#0x1_transaction_fee_EINVALID_BURN_PERCENTAGE">EINVALID_BURN_PERCENTAGE</a>));

    // Make sure stakng <b>module</b> is aware of transaction fees collection.
    <a href="stake.md#0x1_stake_initialize_validator_fees">stake::initialize_validator_fees</a>(starcoin_framework);
    ...
    <b>let</b> collected_fees = <a href="transaction_fee.md#0x1_transaction_fee_CollectedFeesPerBlock">CollectedFeesPerBlock</a> {
        amount: <a href="coin.md#0x1_coin_initialize_aggregatable_coin">coin::initialize_aggregatable_coin</a>(starcoin_framework),
        proposer: <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/option.md#0x1_option_none">option::none</a>(),
        burn_percentage,
    };
    <b>move_to</b>(starcoin_framework, collected_fees);
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_upgrade_burn_percentage">upgrade_burn_percentage</a>(starcoin_framework: &<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer">signer</a>, new_burn_percentage: u8)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_upgrade_burn_percentage">upgrade_burn_percentage</a>(
...
) <b>acquires</b> <a href="transaction_fee.md#0x1_transaction_fee_StarcoinCoinCapabilities">StarcoinCoinCapabilities</a>, <a href="transaction_fee.md#0x1_transaction_fee_CollectedFeesPerBlock">CollectedFeesPerBlock</a> {
    <a href="system_addresses.md#0x1_system_addresses_assert_starcoin_framework">system_addresses::assert_starcoin_framework</a>(starcoin_framework);
    <b>assert</b>!(new_burn_percentage &lt;= 100, <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/error.md#0x1_error_out_of_range">error::out_of_range</a>(<a href="transaction_fee.md#0x1_transaction_fee_EINVALID_BURN_PERCENTAGE">EINVALID_BURN_PERCENTAGE</a>));
    ...
    <b>if</b> (<a href="transaction_fee.md#0x1_transaction_fee_is_fees_collection_enabled">is_fees_collection_enabled</a>()) {
        ...
        <b>let</b> burn_percentage = &<b>mut</b> <b>borrow_global_mut</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_CollectedFeesPerBlock">CollectedFeesPerBlock</a>&gt;(@starcoin_framework).burn_percentage;
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_register_proposer_for_fee_collection">register_proposer_for_fee_collection</a>(proposer_addr: <b>address</b>) <b>acquires</b> <a href="transaction_fee.md#0x1_transaction_fee_CollectedFeesPerBlock">CollectedFeesPerBlock</a> {
    <b>if</b> (<a href="transaction_fee.md#0x1_transaction_fee_is_fees_collection_enabled">is_fees_collection_enabled</a>()) {
        <b>let</b> collected_fees = <b>borrow_global_mut</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_CollectedFeesPerBlock">CollectedFeesPerBlock</a>&gt;(@starcoin_framework);
        <b>let</b> _ = <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/option.md#0x1_option_swap_or_fill">option::swap_or_fill</a>(&<b>mut</b> collected_fees.proposer, proposer_addr);
    }
}
</code></pre>
...
<pre><code><b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_burn_coin_fraction">burn_coin_fraction</a>(<a href="coin.md#0x1_coin">coin</a>: &<b>mut</b> Coin&lt;StarcoinCoin&gt;, burn_percentage: u8) <b>acquires</b> <a href="transaction_fee.md#0x1_transaction_fee_StarcoinCoinCapabilities">StarcoinCoinCapabilities</a> {
    <b>assert</b>!(burn_percentage &lt;= 100, <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/error.md#0x1_error_out_of_range">error::out_of_range</a>(<a href="transaction_fee.md#0x1_transaction_fee_EINVALID_BURN_PERCENTAGE">EINVALID_BURN_PERCENTAGE</a>));
    ...
    <b>if</b> (amount_to_burn &gt; 0) {
        ...
        <a href="coin.md#0x1_coin_burn">coin::burn</a>(
            coin_to_burn,
            &<b>borrow_global</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_StarcoinCoinCapabilities">StarcoinCoinCapabilities</a>&gt;(@starcoin_framework).burn_cap,
        );
    }
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_process_collected_fees">process_collected_fees</a>() <b>acquires</b> <a href="transaction_fee.md#0x1_transaction_fee_StarcoinCoinCapabilities">StarcoinCoinCapabilities</a>, <a href="transaction_fee.md#0x1_transaction_fee_CollectedFeesPerBlock">CollectedFeesPerBlock</a> {
    <b>if</b> (!<a href="transaction_fee.md#0x1_transaction_fee_is_fees_collection_enabled">is_fees_collection_enabled</a>()) {
        <b>return</b>
    };
    <b>let</b> collected_fees = <b>borrow_global_mut</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_CollectedFeesPerBlock">CollectedFeesPerBlock</a>&gt;(@starcoin_framework);
    ...
    // setting proposer <b>to</b> <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/option.md#0x1_option_none">option::none</a>() below.
    <b>if</b> (<a href="coin.md#0x1_coin_is_aggregatable_coin_zero">coin::is_aggregatable_coin_zero</a>(&collected_fees.amount)) {
        <b>if</b> (<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/option.md#0x1_option_is_some">option::is_some</a>(&collected_fees.proposer)) {
            <b>let</b> _ = <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/option.md#0x1_option_extract">option::extract</a>(&<b>mut</b> collected_fees.proposer);
        };
        <b>return</b>
    };
    ...
    <b>if</b> (<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/option.md#0x1_option_is_some">option::is_some</a>(&collected_fees.proposer)) {
        // Extract the <b>address</b> of proposer here and reset it <b>to</b> <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/option.md#0x1_option_none">option::none</a>(). This
        // is particularly useful <b>to</b> avoid <a href="../../../starcoin-stdlib/tests/compiler-v2-doc/any.md#0x1_any">any</a> undesired side-effects <b>where</b> coins are
        ...
        <b>let</b> proposer = <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/option.md#0x1_option_extract">option::extract</a>(&<b>mut</b> collected_fees.proposer);
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_burn_fee">burn_fee</a>(<a href="account.md#0x1_account">account</a>: <b>address</b>, fee: u64) <b>acquires</b> <a href="transaction_fee.md#0x1_transaction_fee_StarcoinFABurnCapabilities">StarcoinFABurnCapabilities</a>, <a href="transaction_fee.md#0x1_transaction_fee_StarcoinCoinCapabilities">StarcoinCoinCapabilities</a> {
    <b>if</b> (<b>exists</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_StarcoinFABurnCapabilities">StarcoinFABurnCapabilities</a>&gt;(@starcoin_framework)) {
        <b>let</b> burn_ref = &<b>borrow_global</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_StarcoinFABurnCapabilities">StarcoinFABurnCapabilities</a>&gt;(@starcoin_framework).burn_ref;
        ...
        <b>let</b> burn_cap = &<b>borrow_global</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_StarcoinCoinCapabilities">StarcoinCoinCapabilities</a>&gt;(@starcoin_framework).burn_cap;
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_mint_and_refund">mint_and_refund</a>(<a href="account.md#0x1_account">account</a>: <b>address</b>, refund: u64) <b>acquires</b> <a href="transaction_fee.md#0x1_transaction_fee_StarcoinCoinMintCapability">StarcoinCoinMintCapability</a> {
    <b>let</b> mint_cap = &<b>borrow_global</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_StarcoinCoinMintCapability">StarcoinCoinMintCapability</a>&gt;(@starcoin_framework).mint_cap;
...
<a id="0x1_transaction_fee_store_starcoin_coin_burn_cap"></a>

## Function `store_starcoin_coin_burn_cap`

Only called during genesis.


<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_store_starcoin_coin_burn_cap">store_starcoin_coin_burn_cap</a>(starcoin_framework: &<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer">signer</a>, burn_cap: <a href="coin.md#0x1_coin_BurnCapability">coin::BurnCapability</a>&lt;<a href="starcoin_coin.md#0x1_starcoin_coin_StarcoinCoin">starcoin_coin::StarcoinCoin</a>&gt;)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_store_starcoin_coin_burn_cap">store_starcoin_coin_burn_cap</a>(starcoin_framework: &<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer">signer</a>, burn_cap: BurnCapability&lt;StarcoinCoin&gt;) {
    <a href="system_addresses.md#0x1_system_addresses_assert_starcoin_framework">system_addresses::assert_starcoin_framework</a>(starcoin_framework);
    ...
    <b>if</b> (<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/features.md#0x1_features_operations_default_to_fa_apt_store_enabled">features::operations_default_to_fa_apt_store_enabled</a>()) {
        ...
        <b>move_to</b>(starcoin_framework, <a href="transaction_fee.md#0x1_transaction_fee_StarcoinFABurnCapabilities">StarcoinFABurnCapabilities</a> { burn_ref });
    } <b>else</b> {
        <b>move_to</b>(starcoin_framework, <a href="transaction_fee.md#0x1_transaction_fee_StarcoinCoinCapabilities">StarcoinCoinCapabilities</a> { burn_cap })
    }
}
</code></pre>
...
<a id="0x1_transaction_fee_convert_to_starcoin_fa_burn_ref"></a>

## Function `convert_to_starcoin_fa_burn_ref`



<pre><code><b>public</b> entry <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_convert_to_starcoin_fa_burn_ref">convert_to_starcoin_fa_burn_ref</a>(starcoin_framework: &<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer">signer</a>)
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_convert_to_starcoin_fa_burn_ref">convert_to_starcoin_fa_burn_ref</a>(starcoin_framework: &<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer">signer</a>) <b>acquires</b> <a href="transaction_fee.md#0x1_transaction_fee_StarcoinCoinCapabilities">StarcoinCoinCapabilities</a> {
    <b>assert</b>!(<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/features.md#0x1_features_operations_default_to_fa_apt_store_enabled">features::operations_default_to_fa_apt_store_enabled</a>(), <a href="transaction_fee.md#0x1_transaction_fee_EFA_GAS_CHARGING_NOT_ENABLED">EFA_GAS_CHARGING_NOT_ENABLED</a>);
    <a href="system_addresses.md#0x1_system_addresses_assert_starcoin_framework">system_addresses::assert_starcoin_framework</a>(starcoin_framework);
    <b>let</b> <a href="transaction_fee.md#0x1_transaction_fee_StarcoinCoinCapabilities">StarcoinCoinCapabilities</a> {
        burn_cap,
    } = <b>move_from</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_StarcoinCoinCapabilities">StarcoinCoinCapabilities</a>&gt;(<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer_address_of">signer::address_of</a>(starcoin_framework));
    <b>let</b> burn_ref = <a href="coin.md#0x1_coin_convert_and_take_paired_burn_ref">coin::convert_and_take_paired_burn_ref</a>(burn_cap);
    <b>move_to</b>(starcoin_framework, <a href="transaction_fee.md#0x1_transaction_fee_StarcoinFABurnCapabilities">StarcoinFABurnCapabilities</a> { burn_ref });
}
</code></pre>
...
<a id="0x1_transaction_fee_store_starcoin_coin_mint_cap"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_store_starcoin_coin_mint_cap">store_starcoin_coin_mint_cap</a>(starcoin_framework: &<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer">signer</a>, mint_cap: <a href="coin.md#0x1_coin_MintCapability">coin::MintCapability</a>&lt;<a href="starcoin_coin.md#0x1_starcoin_coin_StarcoinCoin">starcoin_coin::StarcoinCoin</a>&gt;)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_store_starcoin_coin_mint_cap">store_starcoin_coin_mint_cap</a>(starcoin_framework: &<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer">signer</a>, mint_cap: MintCapability&lt;StarcoinCoin&gt;) {
    <a href="system_addresses.md#0x1_system_addresses_assert_starcoin_framework">system_addresses::assert_starcoin_framework</a>(starcoin_framework);
    <b>move_to</b>(starcoin_framework, <a href="transaction_fee.md#0x1_transaction_fee_StarcoinCoinMintCapability">StarcoinCoinMintCapability</a> { mint_cap })
}
</code></pre>
...
<pre><code>#[deprecated]
<b>public</b> <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_initialize_storage_refund">initialize_storage_refund</a>(_: &<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer">signer</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_initialize_storage_refund">initialize_storage_refund</a>(_: &<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer">signer</a>) {
    <b>abort</b> <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/error.md#0x1_error_not_implemented">error::not_implemented</a>(<a href="transaction_fee.md#0x1_transaction_fee_ENO_LONGER_SUPPORTED">ENO_LONGER_SUPPORTED</a>)
}
</code></pre>
...
<tr>
<td>1</td>
<td>Given the blockchain is in an operating state, it guarantees that the Starcoin framework signer may burn Starcoin coins.</td>
<td>Critical</td>
<td>The StarcoinCoinCapabilities structure is defined in this module and it stores burn capability to burn the gas fees.</td>
...
<td>Critical</td>
<td>The initialize_fee_collection_and_distribution function ensures only the Starcoin framework address calls it.</td>
...
<tr>
<td>6</td>
<td>The presence of the resource, indicating collected fees per block under the Starcoin framework account, is a prerequisite for the successful execution of the following functionalities: Upgrading burn percentage. Registering a block proposer. Processing collected fees.</td>
<td>Low</td>
<td>The functions: upgrade_burn_percentage, register_proposer_for_fee_collection, and process_collected_fees all ensure that the CollectedFeesPerBlock resource exists under starcoin_framework by calling the is_fees_collection_enabled method, which returns a boolean value confirming if the resource exists or not.</td>
...
<b>invariant</b> [suspendable] <a href="chain_status.md#0x1_chain_status_is_operating">chain_status::is_operating</a>() ==&gt; <b>exists</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_StarcoinCoinCapabilities">StarcoinCoinCapabilities</a>&gt;(@starcoin_framework) || <b>exists</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_StarcoinFABurnCapabilities">StarcoinFABurnCapabilities</a>&gt;(@starcoin_framework);
</code></pre>
...
<b>aborts_if</b> <b>exists</b>&lt;ValidatorFees&gt;(starcoin_addr);
<b>include</b> <a href="system_addresses.md#0x1_system_addresses_AbortsIfNotStarcoinFramework">system_addresses::AbortsIfNotStarcoinFramework</a> { <a href="account.md#0x1_account">account</a>: starcoin_framework };
...
<b>aborts_if</b> <b>exists</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_CollectedFeesPerBlock">CollectedFeesPerBlock</a>&gt;(starcoin_addr);
<b>ensures</b> <b>exists</b>&lt;ValidatorFees&gt;(starcoin_addr);
<b>ensures</b> <b>exists</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_CollectedFeesPerBlock">CollectedFeesPerBlock</a>&gt;(starcoin_addr);
</code></pre>
...
<b>ensures</b> <b>exists</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_CollectedFeesPerBlock">CollectedFeesPerBlock</a>&gt;(@starcoin_framework) ==&gt;
    <b>global</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_CollectedFeesPerBlock">CollectedFeesPerBlock</a>&gt;(@starcoin_framework).burn_percentage == new_burn_percentage;
</code></pre>
...
<b>ensures</b> <a href="transaction_fee.md#0x1_transaction_fee_is_fees_collection_enabled">is_fees_collection_enabled</a>() ==&gt;
    <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/option.md#0x1_option_spec_borrow">option::spec_borrow</a>(<b>global</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_CollectedFeesPerBlock">CollectedFeesPerBlock</a>&gt;(@starcoin_framework).proposer) == proposer_addr;
</code></pre>
...
<b>requires</b> <b>exists</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_StarcoinCoinCapabilities">StarcoinCoinCapabilities</a>&gt;(@starcoin_framework);
...
<a id="0x1_transaction_fee_RequiresCollectedFeesPerValueLeqBlockStarcoinSupply"></a>
...
<pre><code><b>schema</b> <a href="transaction_fee.md#0x1_transaction_fee_RequiresCollectedFeesPerValueLeqBlockStarcoinSupply">RequiresCollectedFeesPerValueLeqBlockStarcoinSupply</a> {
    ...
    <b>requires</b>
        (<a href="transaction_fee.md#0x1_transaction_fee_is_fees_collection_enabled">is_fees_collection_enabled</a>() && <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/option.md#0x1_option_is_some">option::is_some</a>(maybe_supply)) ==&gt;
            (<a href="aggregator.md#0x1_aggregator_spec_aggregator_get_val">aggregator::spec_aggregator_get_val</a>(<b>global</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_CollectedFeesPerBlock">CollectedFeesPerBlock</a>&gt;(@starcoin_framework).amount.value) &lt;=
                <a href="optional_aggregator.md#0x1_optional_aggregator_optional_aggregator_value">optional_aggregator::optional_aggregator_value</a>(
                    <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/option.md#0x1_option_spec_borrow">option::spec_borrow</a>(<a href="coin.md#0x1_coin_get_coin_supply_opt">coin::get_coin_supply_opt</a>&lt;StarcoinCoin&gt;())
                ));
}
</code></pre>
...
<pre><code><b>schema</b> <a href="transaction_fee.md#0x1_transaction_fee_ProcessCollectedFeesRequiresAndEnsures">ProcessCollectedFeesRequiresAndEnsures</a> {
    ...
    <b>let</b> <b>post</b> post_collected_fees = <b>global</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_CollectedFeesPerBlock">CollectedFeesPerBlock</a>&gt;(@starcoin_framework);
    ...
    <b>let</b> fees_table = <b>global</b>&lt;<a href="stake.md#0x1_stake_ValidatorFees">stake::ValidatorFees</a>&gt;(@starcoin_framework).fees_table;
    <b>let</b> <b>post</b> post_fees_table = <b>global</b>&lt;<a href="stake.md#0x1_stake_ValidatorFees">stake::ValidatorFees</a>&gt;(@starcoin_framework).fees_table;
    <b>let</b> proposer = <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/option.md#0x1_option_spec_borrow">option::spec_borrow</a>(collected_fees.proposer);
    <b>let</b> fee_to_add = pre_amount - pre_amount * collected_fees.burn_percentage / 100;
    <b>ensures</b> <a href="transaction_fee.md#0x1_transaction_fee_is_fees_collection_enabled">is_fees_collection_enabled</a>() ==&gt; <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/option.md#0x1_option_spec_is_none">option::spec_is_none</a>(post_collected_fees.proposer) && post_amount == 0;
    <b>ensures</b> <a href="transaction_fee.md#0x1_transaction_fee_is_fees_collection_enabled">is_fees_collection_enabled</a>() && <a href="aggregator.md#0x1_aggregator_spec_read">aggregator::spec_read</a>(collected_fees.amount.value) &gt; 0 &&
        <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/option.md#0x1_option_spec_is_some">option::spec_is_some</a>(collected_fees.proposer) ==&gt;
        <b>if</b> (proposer != @vm_reserved) {
            <b>if</b> (<a href="../../../starcoin-stdlib/tests/compiler-v2-doc/table.md#0x1_table_spec_contains">table::spec_contains</a>(fees_table, proposer)) {
                <a href="../../../starcoin-stdlib/tests/compiler-v2-doc/table.md#0x1_table_spec_get">table::spec_get</a>(post_fees_table, proposer).value == <a href="../../../starcoin-stdlib/tests/compiler-v2-doc/table.md#0x1_table_spec_get">table::spec_get</a>(
                    fees_table,
                    proposer
                ).value + fee_to_add
            } <b>else</b> {
                <a href="../../../starcoin-stdlib/tests/compiler-v2-doc/table.md#0x1_table_spec_get">table::spec_get</a>(post_fees_table, proposer).value == fee_to_add
            }
        } <b>else</b> {
            <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/option.md#0x1_option_spec_is_none">option::spec_is_none</a>(post_collected_fees.proposer) && post_amount == 0
        };
}
</code></pre>
...
<code><a href="transaction_fee.md#0x1_transaction_fee_StarcoinCoinCapabilities">StarcoinCoinCapabilities</a></code> should be exists.


<pre><code><b>pragma</b> verify = <b>false</b>;
<b>aborts_if</b> !<b>exists</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_StarcoinCoinCapabilities">StarcoinCoinCapabilities</a>&gt;(@starcoin_framework);
...
<b>aborts_if</b> <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/option.md#0x1_option_spec_is_some">option::spec_is_some</a>(maybe_supply) && value &lt; amount;
...
<b>aborts_if</b> !<b>exists</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_StarcoinCoinMintCapability">StarcoinCoinMintCapability</a>&gt;(@starcoin_framework);
...
<a id="@Specification_1_store_starcoin_coin_burn_cap"></a>
...
Aborts if <code><a href="transaction_fee.md#0x1_transaction_fee_StarcoinCoinCapabilities">StarcoinCoinCapabilities</a></code> already exists.
...
<b>aborts_if</b> <b>exists</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_StarcoinFABurnCapabilities">StarcoinFABurnCapabilities</a>&gt;(addr);
<b>aborts_if</b> <b>exists</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_StarcoinCoinCapabilities">StarcoinCoinCapabilities</a>&gt;(addr);
<b>ensures</b> <b>exists</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_StarcoinFABurnCapabilities">StarcoinFABurnCapabilities</a>&gt;(addr) || <b>exists</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_StarcoinCoinCapabilities">StarcoinCoinCapabilities</a>&gt;(addr);
</code></pre>



<a id="@Specification_1_store_starcoin_coin_mint_cap"></a>
...
Ensure caller is admin.
Aborts if <code><a href="transaction_fee.md#0x1_transaction_fee_StarcoinCoinMintCapability">StarcoinCoinMintCapability</a></code> already exists.
...
<b>aborts_if</b> !<a href="system_addresses.md#0x1_system_addresses_is_starcoin_framework_address">system_addresses::is_starcoin_framework_address</a>(addr);
<b>aborts_if</b> <b>exists</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_StarcoinCoinMintCapability">StarcoinCoinMintCapability</a>&gt;(addr);
<b>ensures</b> <b>exists</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_StarcoinCoinMintCapability">StarcoinCoinMintCapability</a>&gt;(addr);
</code></pre>
