...
<a id="0x1_starcoin_account"></a>

# Module `0x1::starcoin_account`



-  [Resource `DirectTransferConfig`](#0x1_starcoin_account_DirectTransferConfig)
-  [Struct `DirectCoinTransferConfigUpdatedEvent`](#0x1_starcoin_account_DirectCoinTransferConfigUpdatedEvent)
-  [Struct `DirectCoinTransferConfigUpdated`](#0x1_starcoin_account_DirectCoinTransferConfigUpdated)
-  [Constants](#@Constants_0)
-  [Function `create_account`](#0x1_starcoin_account_create_account)
-  [Function `batch_transfer`](#0x1_starcoin_account_batch_transfer)
-  [Function `transfer`](#0x1_starcoin_account_transfer)
-  [Function `batch_transfer_coins`](#0x1_starcoin_account_batch_transfer_coins)
...
-  [Function `ensure_primary_fungible_store_exists`](#0x1_starcoin_account_ensure_primary_fungible_store_exists)
-  [Function `primary_fungible_store_address`](#0x1_starcoin_account_primary_fungible_store_address)
...
<a id="0x1_starcoin_account_DirectTransferConfig"></a>
...
<pre><code><b>struct</b> <a href="starcoin_account.md#0x1_starcoin_account_DirectTransferConfig">DirectTransferConfig</a> <b>has</b> key
</code></pre>
...
<dt>
<code>update_coin_transfer_events: <a href="event.md#0x1_event_EventHandle">event::EventHandle</a>&lt;<a href="starcoin_account.md#0x1_starcoin_account_DirectCoinTransferConfigUpdatedEvent">starcoin_account::DirectCoinTransferConfigUpdatedEvent</a>&gt;</code>
</dt>
<dd>
...
<a id="0x1_starcoin_account_DirectCoinTransferConfigUpdatedEvent"></a>
...
<pre><code><b>struct</b> <a href="starcoin_account.md#0x1_starcoin_account_DirectCoinTransferConfigUpdatedEvent">DirectCoinTransferConfigUpdatedEvent</a> <b>has</b> drop, store
</code></pre>
...
<a id="0x1_starcoin_account_DirectCoinTransferConfigUpdated"></a>
...
<b>struct</b> <a href="starcoin_account.md#0x1_starcoin_account_DirectCoinTransferConfigUpdated">DirectCoinTransferConfigUpdated</a> <b>has</b> drop, store
</code></pre>
...
<a id="0x1_starcoin_account_EACCOUNT_DOES_NOT_ACCEPT_DIRECT_COIN_TRANSFERS"></a>

Account opted out of receiving coins that they did not register to receive.


<pre><code><b>const</b> <a href="starcoin_account.md#0x1_starcoin_account_EACCOUNT_DOES_NOT_ACCEPT_DIRECT_COIN_TRANSFERS">EACCOUNT_DOES_NOT_ACCEPT_DIRECT_COIN_TRANSFERS</a>: u64 = 3;
</code></pre>



<a id="0x1_starcoin_account_EACCOUNT_DOES_NOT_ACCEPT_DIRECT_TOKEN_TRANSFERS"></a>

Account opted out of directly receiving NFT tokens.


<pre><code><b>const</b> <a href="starcoin_account.md#0x1_starcoin_account_EACCOUNT_DOES_NOT_ACCEPT_DIRECT_TOKEN_TRANSFERS">EACCOUNT_DOES_NOT_ACCEPT_DIRECT_TOKEN_TRANSFERS</a>: u64 = 4;
</code></pre>



<a id="0x1_starcoin_account_EACCOUNT_NOT_FOUND"></a>

Account does not exist.


<pre><code><b>const</b> <a href="starcoin_account.md#0x1_starcoin_account_EACCOUNT_NOT_FOUND">EACCOUNT_NOT_FOUND</a>: u64 = 1;
</code></pre>
...
<a id="0x1_starcoin_account_EMISMATCHING_RECIPIENTS_AND_AMOUNTS_LENGTH"></a>

The lengths of the recipients and amounts lists don't match.


<pre><code><b>const</b> <a href="starcoin_account.md#0x1_starcoin_account_EMISMATCHING_RECIPIENTS_AND_AMOUNTS_LENGTH">EMISMATCHING_RECIPIENTS_AND_AMOUNTS_LENGTH</a>: u64 = 5;
</code></pre>



<a id="0x1_starcoin_account_create_account"></a>
...
<a id="0x1_starcoin_account_batch_transfer"></a>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_batch_transfer">batch_transfer</a>(source: &<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer">signer</a>, recipients: <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;, amounts: <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/vector.md#0x1_vector">vector</a>&lt;u64&gt;)
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_batch_transfer">batch_transfer</a>(source: &<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer">signer</a>, recipients: <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;, amounts: <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/vector.md#0x1_vector">vector</a>&lt;u64&gt;) {
    <b>let</b> recipients_len = <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/vector.md#0x1_vector_length">vector::length</a>(&recipients);
    <b>assert</b>!(
        recipients_len == <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/vector.md#0x1_vector_length">vector::length</a>(&amounts),
        <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="starcoin_account.md#0x1_starcoin_account_EMISMATCHING_RECIPIENTS_AND_AMOUNTS_LENGTH">EMISMATCHING_RECIPIENTS_AND_AMOUNTS_LENGTH</a>),
    );

    <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/vector.md#0x1_vector_enumerate_ref">vector::enumerate_ref</a>(&recipients, |i, <b>to</b>| {
        <b>let</b> amount = *<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/vector.md#0x1_vector_borrow">vector::borrow</a>(&amounts, i);
        <a href="starcoin_account.md#0x1_starcoin_account_transfer">transfer</a>(source, *<b>to</b>, amount);
    });
}
</code></pre>
...
<a id="0x1_starcoin_account_transfer"></a>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_transfer">transfer</a>(source: &<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer">signer</a>, <b>to</b>: <b>address</b>, amount: u64)
</code></pre>
...
<a id="0x1_starcoin_account_batch_transfer_coins"></a>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_batch_transfer_coins">batch_transfer_coins</a>&lt;CoinType&gt;(from: &<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer">signer</a>, recipients: <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;, amounts: <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/vector.md#0x1_vector">vector</a>&lt;u64&gt;)
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_batch_transfer_coins">batch_transfer_coins</a>&lt;CoinType&gt;(
    from: &<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer">signer</a>, recipients: <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;, amounts: <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/vector.md#0x1_vector">vector</a>&lt;u64&gt;) <b>acquires</b> <a href="starcoin_account.md#0x1_starcoin_account_DirectTransferConfig">DirectTransferConfig</a> {
    <b>let</b> recipients_len = <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/vector.md#0x1_vector_length">vector::length</a>(&recipients);
    <b>assert</b>!(
        recipients_len == <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/vector.md#0x1_vector_length">vector::length</a>(&amounts),
        <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="starcoin_account.md#0x1_starcoin_account_EMISMATCHING_RECIPIENTS_AND_AMOUNTS_LENGTH">EMISMATCHING_RECIPIENTS_AND_AMOUNTS_LENGTH</a>),
    ...
    <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/vector.md#0x1_vector_enumerate_ref">vector::enumerate_ref</a>(&recipients, |i, <b>to</b>| {
        <b>let</b> amount = *<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/vector.md#0x1_vector_borrow">vector::borrow</a>(&amounts, i);
        <a href="starcoin_account.md#0x1_starcoin_account_transfer_coins">transfer_coins</a>&lt;CoinType&gt;(from, *<b>to</b>, amount);
    });
}
</code></pre>
...
<a id="0x1_starcoin_account_transfer_coins"></a>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_transfer_coins">transfer_coins</a>&lt;CoinType&gt;(from: &<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer">signer</a>, <b>to</b>: <b>address</b>, amount: u64)
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_transfer_coins">transfer_coins</a>&lt;CoinType&gt;(from: &<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer">signer</a>, <b>to</b>: <b>address</b>, amount: u64) <b>acquires</b> <a href="starcoin_account.md#0x1_starcoin_account_DirectTransferConfig">DirectTransferConfig</a> {
...
<a id="0x1_starcoin_account_deposit_coins"></a>
...
<pre><code><b>public</b> <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_deposit_coins">deposit_coins</a>&lt;CoinType&gt;(<b>to</b>: <b>address</b>, coins: <a href="coin.md#0x1_coin_Coin">coin::Coin</a>&lt;CoinType&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_deposit_coins">deposit_coins</a>&lt;CoinType&gt;(<b>to</b>: <b>address</b>, coins: Coin&lt;CoinType&gt;) <b>acquires</b> <a href="starcoin_account.md#0x1_starcoin_account_DirectTransferConfig">DirectTransferConfig</a> {
    <b>if</b> (!<a href="account.md#0x1_account_exists_at">account::exists_at</a>(<b>to</b>)) {
        <a href="starcoin_account.md#0x1_starcoin_account_create_account">create_account</a>(<b>to</b>);
        <b>spec</b> {
    ...
    <b>if</b> (!<a href="coin.md#0x1_coin_is_account_registered">coin::is_account_registered</a>&lt;CoinType&gt;(<b>to</b>)) {
        <b>assert</b>!(
            <a href="starcoin_account.md#0x1_starcoin_account_can_receive_direct_coin_transfers">can_receive_direct_coin_transfers</a>(<b>to</b>),
            <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/error.md#0x1_error_permission_denied">error::permission_denied</a>(<a href="starcoin_account.md#0x1_starcoin_account_EACCOUNT_DOES_NOT_ACCEPT_DIRECT_COIN_TRANSFERS">EACCOUNT_DOES_NOT_ACCEPT_DIRECT_COIN_TRANSFERS</a>),
        );
...
<a id="0x1_starcoin_account_assert_account_exists"></a>

## Function `assert_account_exists`



<pre><code><b>public</b> <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_assert_account_exists">assert_account_exists</a>(addr: <b>address</b>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_assert_account_exists">assert_account_exists</a>(addr: <b>address</b>) {
    <b>assert</b>!(<a href="account.md#0x1_account_exists_at">account::exists_at</a>(addr), <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/error.md#0x1_error_not_found">error::not_found</a>(<a href="starcoin_account.md#0x1_starcoin_account_EACCOUNT_NOT_FOUND">EACCOUNT_NOT_FOUND</a>));
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_assert_account_is_registered_for_apt">assert_account_is_registered_for_apt</a>(addr: <b>address</b>) {
    ...
    <b>assert</b>!(<a href="coin.md#0x1_coin_is_account_registered">coin::is_account_registered</a>&lt;StarcoinCoin&gt;(addr), <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/error.md#0x1_error_not_found">error::not_found</a>(<a href="starcoin_account.md#0x1_starcoin_account_EACCOUNT_NOT_REGISTERED_FOR_APT">EACCOUNT_NOT_REGISTERED_FOR_APT</a>));
}
</code></pre>
...
<a id="0x1_starcoin_account_set_allow_direct_coin_transfers"></a>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_set_allow_direct_coin_transfers">set_allow_direct_coin_transfers</a>(<a href="account.md#0x1_account">account</a>: &<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer">signer</a>, allow: bool)
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_set_allow_direct_coin_transfers">set_allow_direct_coin_transfers</a>(<a href="account.md#0x1_account">account</a>: &<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer">signer</a>, allow: bool) <b>acquires</b> <a href="starcoin_account.md#0x1_starcoin_account_DirectTransferConfig">DirectTransferConfig</a> {
    ...
    <b>if</b> (<b>exists</b>&lt;<a href="starcoin_account.md#0x1_starcoin_account_DirectTransferConfig">DirectTransferConfig</a>&gt;(addr)) {
        <b>let</b> direct_transfer_config = <b>borrow_global_mut</b>&lt;<a href="starcoin_account.md#0x1_starcoin_account_DirectTransferConfig">DirectTransferConfig</a>&gt;(addr);
        ...
        <b>if</b> (std::features::module_event_migration_enabled()) {
            emit(<a href="starcoin_account.md#0x1_starcoin_account_DirectCoinTransferConfigUpdated">DirectCoinTransferConfigUpdated</a> { <a href="account.md#0x1_account">account</a>: addr, new_allow_direct_transfers: allow });
        };
        emit_event(
            &<b>mut</b> direct_transfer_config.update_coin_transfer_events,
            <a href="starcoin_account.md#0x1_starcoin_account_DirectCoinTransferConfigUpdatedEvent">DirectCoinTransferConfigUpdatedEvent</a> { new_allow_direct_transfers: allow });
    } <b>else</b> {
        <b>let</b> direct_transfer_config = <a href="starcoin_account.md#0x1_starcoin_account_DirectTransferConfig">DirectTransferConfig</a> {
            allow_arbitrary_coin_transfers: allow,
            update_coin_transfer_events: new_event_handle&lt;<a href="starcoin_account.md#0x1_starcoin_account_DirectCoinTransferConfigUpdatedEvent">DirectCoinTransferConfigUpdatedEvent</a>&gt;(<a href="account.md#0x1_account">account</a>),
        };
        <b>if</b> (std::features::module_event_migration_enabled()) {
            emit(<a href="starcoin_account.md#0x1_starcoin_account_DirectCoinTransferConfigUpdated">DirectCoinTransferConfigUpdated</a> { <a href="account.md#0x1_account">account</a>: addr, new_allow_direct_transfers: allow });
        };
...
<a id="0x1_starcoin_account_can_receive_direct_coin_transfers"></a>
...
<pre><code>#[view]
<b>public</b> <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_can_receive_direct_coin_transfers">can_receive_direct_coin_transfers</a>(<a href="account.md#0x1_account">account</a>: <b>address</b>): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_can_receive_direct_coin_transfers">can_receive_direct_coin_transfers</a>(<a href="account.md#0x1_account">account</a>: <b>address</b>): bool <b>acquires</b> <a href="starcoin_account.md#0x1_starcoin_account_DirectTransferConfig">DirectTransferConfig</a> {
    !<b>exists</b>&lt;<a href="starcoin_account.md#0x1_starcoin_account_DirectTransferConfig">DirectTransferConfig</a>&gt;(<a href="account.md#0x1_account">account</a>) ||
        <b>borrow_global</b>&lt;<a href="starcoin_account.md#0x1_starcoin_account_DirectTransferConfig">DirectTransferConfig</a>&gt;(<a href="account.md#0x1_account">account</a>).allow_arbitrary_coin_transfers
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_register_apt">register_apt</a>(account_signer: &<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer">signer</a>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_register_apt">register_apt</a>(account_signer: &<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer">signer</a>) {
    <b>if</b> (<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/features.md#0x1_features_new_accounts_default_to_fa_apt_store_enabled">features::new_accounts_default_to_fa_apt_store_enabled</a>()) {
        <a href="starcoin_account.md#0x1_starcoin_account_ensure_primary_fungible_store_exists">ensure_primary_fungible_store_exists</a>(<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer_address_of">signer::address_of</a>(account_signer));
    } <b>else</b> {
...
<a id="0x1_starcoin_account_fungible_transfer_only"></a>
...
<pre><code><b>public</b>(<b>friend</b>) entry <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_fungible_transfer_only">fungible_transfer_only</a>(source: &<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer">signer</a>, <b>to</b>: <b>address</b>, amount: u64)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) entry <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_fungible_transfer_only">fungible_transfer_only</a>(
    source: &<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer">signer</a>, <b>to</b>: <b>address</b>, amount: u64
) {
    <b>let</b> sender_store = <a href="starcoin_account.md#0x1_starcoin_account_ensure_primary_fungible_store_exists">ensure_primary_fungible_store_exists</a>(<a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer_address_of">signer::address_of</a>(source));
    <b>let</b> recipient_store = <a href="starcoin_account.md#0x1_starcoin_account_ensure_primary_fungible_store_exists">ensure_primary_fungible_store_exists</a>(<b>to</b>);
...
<a id="0x1_starcoin_account_is_fungible_balance_at_least"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_is_fungible_balance_at_least">is_fungible_balance_at_least</a>(<a href="account.md#0x1_account">account</a>: <b>address</b>, amount: u64): bool {
    <b>let</b> store_addr = <a href="starcoin_account.md#0x1_starcoin_account_primary_fungible_store_address">primary_fungible_store_address</a>(<a href="account.md#0x1_account">account</a>);
...
<a id="0x1_starcoin_account_burn_from_fungible_store"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_burn_from_fungible_store">burn_from_fungible_store</a>(
    ref: &BurnRef,
...
<a id="0x1_starcoin_account_ensure_primary_fungible_store_exists"></a>
...
<a id="0x1_starcoin_account_primary_fungible_store_address"></a>
...
<pre><code>inline <b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_primary_fungible_store_address">primary_fungible_store_address</a>(<a href="account.md#0x1_account">account</a>: <b>address</b>): <b>address</b> {
...
<tr>
<td>1</td>
<td>During the creation of an Starcoin account the following rules should hold: (1) the authentication key should be 32 bytes in length, (2) an Starcoin account should not already exist for that authentication key, and (3) the address of the authentication key should not be equal to a reserved address (0x0, 0x1, or 0x3).</td>
<td>Critical</td>
...
<tr>
<td>2</td>
<td>After creating an Starcoin account, the account should become registered to receive StarcoinCoin.</td>
<td>Critical</td>
<td>The create_account function creates a new account for the particular address and registers StarcoinCoin.</td>
...
<tr>
<td>5</td>
<td>The transfer function should ensure an account is created for the provided destination if one does not exist; then, register StarcoinCoin for that account if a particular is unregistered before transferring the amount.</td>
<td>Critical</td>
<td>The transfer function checks if the recipient account exists. If the account does not exist, the function creates one and registers the account to StarcoinCoin if not registered.</td>
...
<tr>
<td>7</td>
<td>When performing a batch transfer of Starcoin Coin and/or a batch transfer of a custom coin type, it should ensure that the vector containing destination addresses and the vector containing the corresponding amounts are equal in length.</td>
<td>Low</td>
...
<b>include</b> <a href="starcoin_account.md#0x1_starcoin_account_CreateAccountAbortsIf">CreateAccountAbortsIf</a>;
...
<a id="0x1_starcoin_account_CreateAccountAbortsIf"></a>


<pre><code><b>schema</b> <a href="starcoin_account.md#0x1_starcoin_account_CreateAccountAbortsIf">CreateAccountAbortsIf</a> {
    auth_key: <b>address</b>;
    <b>aborts_if</b> <b>exists</b>&lt;<a href="account.md#0x1_account_Account">account::Account</a>&gt;(auth_key);
    <b>aborts_if</b> <a href="starcoin_account.md#0x1_starcoin_account_length_judgment">length_judgment</a>(auth_key);
    <b>aborts_if</b> auth_key == @vm_reserved || auth_key == @starcoin_framework || auth_key == @starcoin_token;
}
</code></pre>
...
<a id="0x1_starcoin_account_length_judgment"></a>


<pre><code><b>fun</b> <a href="starcoin_account.md#0x1_starcoin_account_length_judgment">length_judgment</a>(auth_key: <b>address</b>): bool {
   <b>use</b> std::bcs;

   <b>let</b> authentication_key = <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/bcs.md#0x1_bcs_to_bytes">bcs::to_bytes</a>(auth_key);
...
<b>let</b> account_addr_source = <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer_address_of">signer::address_of</a>(source);
...
<pre><code><b>pragma</b> verify = <b>false</b>;
<b>let</b> account_addr_source = <a href="../../../starcoin-stdlib/../move-stdlib/tests/compiler-v2-doc/signer.md#0x1_signer_address_of">signer::address_of</a>(from);
...
<b>aborts_if</b> <b>exists</b> i in 0..len(recipients):
    !<a href="coin.md#0x1_coin_spec_is_account_registered">coin::spec_is_account_registered</a>&lt;CoinType&gt;(recipients[i]) && !<a href="../../../starcoin-stdlib/tests/compiler-v2-doc/type_info.md#0x1_type_info_spec_is_struct">type_info::spec_is_struct</a>&lt;CoinType&gt;();
</code></pre>
...
<b>requires</b> account_addr_source != <b>to</b>;
<b>include</b> <a href="starcoin_account.md#0x1_starcoin_account_CreateAccountTransferAbortsIf">CreateAccountTransferAbortsIf</a>;
<b>include</b> <a href="starcoin_account.md#0x1_starcoin_account_WithdrawAbortsIf">WithdrawAbortsIf</a>&lt;CoinType&gt;;
<b>include</b> <a href="starcoin_account.md#0x1_starcoin_account_GuidAbortsIf">GuidAbortsIf</a>&lt;CoinType&gt;;
<b>include</b> <a href="starcoin_account.md#0x1_starcoin_account_RegistCoinAbortsIf">RegistCoinAbortsIf</a>&lt;CoinType&gt;;
<b>include</b> <a href="starcoin_account.md#0x1_starcoin_account_TransferEnsures">TransferEnsures</a>&lt;CoinType&gt;;
...
<b>ensures</b> <b>exists</b>&lt;starcoin_framework::account::Account&gt;(<b>to</b>);
<b>ensures</b> <b>exists</b>&lt;starcoin_framework::coin::CoinStore&lt;CoinType&gt;&gt;(<b>to</b>);
</code></pre>
...
<b>ensures</b> result == (
    !<b>exists</b>&lt;<a href="starcoin_account.md#0x1_starcoin_account_DirectTransferConfig">DirectTransferConfig</a>&gt;(<a href="account.md#0x1_account">account</a>) ||
        <b>global</b>&lt;<a href="starcoin_account.md#0x1_starcoin_account_DirectTransferConfig">DirectTransferConfig</a>&gt;(<a href="account.md#0x1_account">account</a>).allow_arbitrary_coin_transfers
);
</code></pre>
...
<a id="0x1_starcoin_account_CreateAccountTransferAbortsIf"></a>


<pre><code><b>schema</b> <a href="starcoin_account.md#0x1_starcoin_account_CreateAccountTransferAbortsIf">CreateAccountTransferAbortsIf</a> {
    <b>to</b>: <b>address</b>;
    <b>aborts_if</b> !<a href="account.md#0x1_account_exists_at">account::exists_at</a>(<b>to</b>) && <a href="starcoin_account.md#0x1_starcoin_account_length_judgment">length_judgment</a>(<b>to</b>);
    <b>aborts_if</b> !<a href="account.md#0x1_account_exists_at">account::exists_at</a>(<b>to</b>) && (<b>to</b> == @vm_reserved || <b>to</b> == @starcoin_framework || <b>to</b> == @starcoin_token);
}
</code></pre>
...
<a id="0x1_starcoin_account_WithdrawAbortsIf"></a>


<pre><code><b>schema</b> <a href="starcoin_account.md#0x1_starcoin_account_WithdrawAbortsIf">WithdrawAbortsIf</a>&lt;CoinType&gt; {
...
<a id="0x1_starcoin_account_GuidAbortsIf"></a>


<pre><code><b>schema</b> <a href="starcoin_account.md#0x1_starcoin_account_GuidAbortsIf">GuidAbortsIf</a>&lt;CoinType&gt; {
    <b>to</b>: <b>address</b>;
...
<a id="0x1_starcoin_account_RegistCoinAbortsIf"></a>


<pre><code><b>schema</b> <a href="starcoin_account.md#0x1_starcoin_account_RegistCoinAbortsIf">RegistCoinAbortsIf</a>&lt;CoinType&gt; {
    <b>to</b>: <b>address</b>;
    <b>aborts_if</b> !<a href="coin.md#0x1_coin_spec_is_account_registered">coin::spec_is_account_registered</a>&lt;CoinType&gt;(<b>to</b>) && !<a href="../../../starcoin-stdlib/tests/compiler-v2-doc/type_info.md#0x1_type_info_spec_is_struct">type_info::spec_is_struct</a>&lt;CoinType&gt;();
    <b>aborts_if</b> <b>exists</b>&lt;starcoin_framework::account::Account&gt;(<b>to</b>);
    <b>aborts_if</b> <a href="../../../starcoin-stdlib/tests/compiler-v2-doc/type_info.md#0x1_type_info_type_of">type_info::type_of</a>&lt;CoinType&gt;() != <a href="../../../starcoin-stdlib/tests/compiler-v2-doc/type_info.md#0x1_type_info_type_of">type_info::type_of</a>&lt;StarcoinCoin&gt;();
}
</code></pre>
...
<a id="0x1_starcoin_account_TransferEnsures"></a>


<pre><code><b>schema</b> <a href="starcoin_account.md#0x1_starcoin_account_TransferEnsures">TransferEnsures</a>&lt;CoinType&gt; {
    <b>to</b>: <b>address</b>;
