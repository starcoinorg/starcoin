...
module starcoin_framework::account {
    ...
    #[test_only]
    /// Create signer for testing, independently of an Starcoin-style `Account`.
    ...
    /// `create_account` to attempt to claim an account ahead of the creation of a resource account, if found Starcoin will
    ...
    public(friend) fun create_framework_reserved_account(addr: address): (signer, SignerCapability) {
        assert!(
            system_addresses::is_framework_reserved_address(addr),
