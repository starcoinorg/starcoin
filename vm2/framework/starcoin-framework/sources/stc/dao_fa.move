module starcoin_framework::dao_fa {
    ...
    use starcoin_framework::fungible_asset::{Self, FungibleStore, FungibleAsset, Metadata};
    ...
    use starcoin_framework::treasury_fa;
    ...
    public fun quorum_votes<CoinT>(): u128 {
        ...
        let balance_in_treasury = treasury_fa::balance<CoinT>(get_starcoin_framework());
