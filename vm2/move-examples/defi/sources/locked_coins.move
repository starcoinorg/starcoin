...
module defi::locked_coins {
    ...
    #[test(starcoin_framework = @0x1, sponsor = @0x123, recipient = @0x234)]
    public entry fun test_recipient_can_claim_coins(
        starcoin_framework: &signer, sponsor: &signer, recipient: &signer) acquires Locks {
        let burn_cap = setup(starcoin_framework, sponsor);
    ...
    #[test(starcoin_framework = @0x1, sponsor = @0x123, recipient_1 = @0x234, recipient_2 = @0x345)]
    public entry fun test_sponsor_can_batch_update_lockup(
        starcoin_framework: &signer, sponsor: &signer, recipient_1: &signer, recipient_2: &signer) acquires Locks {
        let burn_cap = setup(starcoin_framework, sponsor);
    ...
    #[test(starcoin_framework = @0x1, sponsor = @0x123, recipient = @0x234, withdrawal = @0x345)]
    public entry fun test_sponsor_can_cancel_lockup(
        starcoin_framework: &signer, sponsor: &signer, recipient: &signer, withdrawal: &signer) acquires Locks {
        let burn_cap = setup(starcoin_framework, sponsor);
        let recipient_addr = signer::address_of(recipient);
    ...
    #[test(starcoin_framework = @0x1, sponsor = @0x123, recipient_1 = @0x234, recipient_2 = @0x345, withdrawal = @0x456)]
    ...
    #[test(starcoin_framework = @0x1, sponsor = @0x123, recipient = @0x234, withdrawal = @0x456)]
    ...
    public entry fun test_can_change_withdrawal_address_if_no_active_locks_exist(
        ...
        cancel_lockup<STC>(sponsor, recipient_addr);
        update_withdrawal_address<STC>(sponsor, sponsor_address);
        assert!(withdrawal_address<STC>(sponsor_address) == sponsor_address, 0);
        coin::destroy_burn_cap(burn_cap);
    }
}
