...
pub trait ChainService {
    ...
    fn get_transaction_info(&self, txn_hash: HashValue) -> Result<Vec<TransactionInfo>>;
    ...
    Clone + std::marker::Unpin + std::marker::Sync + std::marker::Send
{
    ...
    async fn get_transaction_info(self, txn_hash: HashValue) -> Result<Vec<TransactionInfo>>;
